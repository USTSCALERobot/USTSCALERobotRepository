...
def parse_args():
    ...
    parser.add_argument("--image", type=str, default="/home/scalepi/Desktop/savephototest/help.png",
                        help="Path to the input image")
    parser.add_argument("--bbox", type=str, default="0.65,0.33,0.90,0.47",
...
try:
    ...
    print(f"Module error: {e}\nPlease install the missing module(s) in your activated environment (e.g. pip install pytesseract).")
    sys.exit(1)

# --- OCR Code (your existing OCR functions go here) ---
# For brevity, only the function names are shown here.
def crop_and_threshold(image_path, bbox, save_folder=None):
    # ... (your cropping, thresholding code) ...
    try:
        ...
        threshold = np.argmax(cumulative_sum >= 0.35 * total_pixels)
